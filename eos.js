...
Eos.BubbleQueue.prototype.attachToSlide = function (slide)
{
  var self = this;
  slide.bind('slideStart', function () {
    self.trigger('slideStart');
  });
  slide.bind('slideEnd', function () {
    self.trigger('slideEnd');
  });
};
...
Eos.Bubble.prototype.registerParent = function (queue)
{
  ...
  if (this.config.autoClose) {
    queue.bind('slideEnd', function (e, bubble) {
...
Eos.InteractiveSlide.prototype.setup = function (sm)
{
  ...
  this.bubblequeue.attachToSlide(this);
  this.initBubbles();
...
Eos.Timer.prototype.cancel = function ()
{
  if (this.timeout) {
...
Eos.Timer.prototype.attachToSlide = function (slide)
{
  var self = this;
  slide.bind('slideEnd', function () {
    self.cancel();
...
Eos.TimerDisplay.prototype.attachTo = function (timer)
{
  ...
  timer.bind("cancel", $.proxy(this.cancel, this));
};
